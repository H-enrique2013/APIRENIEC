...
################################################################################
## Form generated from reading UI file 'new_preventivo_edit.ui'
##
...
"}")
    ...
    def retranslateUi(self, NewBook):
        ...
        self.label.setText(QCoreApplication.translate("NewBook", u"<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600; color:#ffffff;\">MODIFICAR MANTENIMIENTO PREVENTIVO</span></p></body></html>", None))
